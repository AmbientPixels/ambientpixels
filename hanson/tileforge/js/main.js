...
window.TileForgeMeta = window.TileForgeMeta || {
  ...
  latest: '2.4.1 hotfixes: Iris export CSV compatibility, Locale Validator + report pill/modal, Transform Data guidance, Case Converter space remover + Title inherit'
};
...
/* duplicate About renderer removed — single source lives in lab/TileForge/js/settings.js:createAboutTabContent() */
