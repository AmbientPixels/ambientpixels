...
(function() {
  ...
  const ATTRIBUTE_CAP_MAX = 10; // Absolute max attributes (raised from 4)
  ...
  // Loaded from cardforge-presets.js → window.PresetConfigurations
  const PresetConfigurations = window.PresetConfigurations || {};
  ...
  function updateBuffEmptyState() {
    ...
    progressEl.innerHTML =
      ...
      '<span class="buff-progress-chip"><i class="fas fa-layer-group"></i> ' + slots + '/6 slots</span>' +
