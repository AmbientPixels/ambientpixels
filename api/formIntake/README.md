...
- Signed: `— AmbientPixels / AmbientOS`
...
[ ] Contact modal     → submits to AmbientOS (not Formspree), shows success
...
- `js/form-intake.js` — Frontend submit helper (binds to `data-ambientos-intake`)
- `modules/company/inbound.html` — Inbound viewer page
- `modules/company/js/inbound-intake.js` — Viewer client logic

## Files Modified

- `modules/contact-modal.html` — Removed Formspree, added `data-ambientos-intake`
...
- `support/index.html` — Migrated engage form from Formspree to AmbientOS intake
