// reportRenderer.js — ConversionCore HTML report template
...
<head>
  ...
  <title>Conversion Audit: ${escapeHtml(report.url)}</title>
</head>
<body style="margin:0;padding:0;background:#071019;color:#e2e8f0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;line-height:1.6;">
  <div style="max-width:800px;margin:0 auto;padding:40px 24px;">
    ...
    <div style="text-align:center;margin-bottom:40px;">
      <h1 style="color:#10b981;font-size:24px;margin:0 0 4px;">ConversionCore</h1>
      <p style="color:#94a3b8;font-size:14px;margin:0;">Conversion Audit Report</p>
    ...
    <div style="text-align:center;background:#0d1a2a;border:1px solid rgba(255,255,255,0.08);border-radius:16px;padding:40px;margin-bottom:32px;">
      ...
      <p style="margin:16px 0 4px;font-size:14px;color:#94a3b8;">Conversion Health Score</p>
    ...
    <div style="text-align:center;color:#475569;font-size:11px;padding-top:24px;border-top:1px solid rgba(255,255,255,0.04);">
      <p style="margin:0;">Powered by <a href="https://ambientpixels.ai/conversioncore" style="color:#10b981;text-decoration:none;">ConversionCore</a> by AmbientPixels</p>
    </div>
  </div>
</body>
</html>`;
