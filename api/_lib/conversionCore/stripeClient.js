// stripeClient.js — ConversionCore Stripe integration
...
const SITE_URL = process.env.CC_SITE_URL || 'https://ambientpixels.ai';
...
async function createCheckoutSession({ reportId, url, email, priceType }) {
  ...
  params.append('success_url', SITE_URL + '/conversioncore/report.html?id=' + reportId + '&session_id={CHECKOUT_SESSION_ID}');
  params.append('cancel_url', SITE_URL + '/conversioncore/?cancelled=1');
