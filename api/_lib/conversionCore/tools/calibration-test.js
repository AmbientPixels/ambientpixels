...
// Run from repo root: node ambientpixels/api/_lib/conversionCore/tools/calibration-test.js --all
...
if (args.includes('--all')) {
  ...
  console.log('ConversionCore Calibration Test');
  console.log('===============================');
  console.log('Usage:');
...
async function runTests() {
  console.log('\nConversionCore Calibration Test');
  console.log('==============================\n');
