...
const ENDPOINTS = [
  ...
  { id: 'azure_blob',  name: 'Azure Blob Storage',   url: 'https://ambientpixelsstorage.blob.core.windows.net/',                method: 'GET', expect: [200, 400, 409] },
  ...
  { id: 'linkedin',    name: 'LinkedIn API',          url: 'https://api.linkedin.com/',                                         method: 'GET', expect: [200, 401, 403] }
];
