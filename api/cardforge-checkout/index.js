...
module.exports = async function (context, req) {
  ...
  try {
    ...
    const successUrl = SITE_URL + '/cardforge/?checkout=success&session_id={CHECKOUT_SESSION_ID}';
    const cancelUrl = SITE_URL + '/cardforge/?checkout=cancelled';
    ...
    context.log.error('[CardForge Checkout] Error: ' + error.message);
    context.res = {
      status: 500,
      headers: CORS_HEADERS,
