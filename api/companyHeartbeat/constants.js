...
const AGENT_ROLES = {
  ...
  cipher: { name: 'Cipher', role: 'Strategic CFO', tier: 3, monthlyCap: 2.50, focus: 'Financial Intelligence Dashboard (budget, agent efficiency, campaign ROI), weekly financial reports, threshold-based alerts (daily >$0.75 RED, waste >50% RED), proactive ROI commentary on priority work',
  ...
  scribe: { name: 'Scribe', role: 'Content Director', tier: 3, monthlyCap: 8.00, focus: 'strategic content in founder voice (no em dashes, lowercase casual, 5th-grade reading, authentic), blog drafts, product briefs, social copy, documentation, content repurposing, performance-driven writing (blog views + social engagement)',
