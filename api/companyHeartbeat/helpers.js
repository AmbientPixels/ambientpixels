...
// ── Proposal title similarity ────────────────────────────────────────────────
// Fuzzy match for objective/campaign proposal dedup. The exact-title checks let
// rewordings through — three first-customer objectives went live simultaneously
// (obj-first-customer / obj-mrz8kvg9 / obj-ms2msmuy, CEO escalation 2026-07-27).
// Stopword-strip + crude suffix stem, scored as overlap over the smaller token
// set. 0.6+ = same intent. Lexically distant paraphrases (e.g. "Achieve Budget
// Compliance" vs "Implement Financial Guardrails") still score low — the
// north-star-metric check in the propose-objective gate covers that class.
