...
const { _buildBlockedProposal, _normalizeProposal, _isValidProposal, normalizeAgentResult, _normalizeEnvelope } = require('./normalization');
const { _resolveWorkspaceFiles } = require('./workspace-context');
const { _fetchSiteIntel, _buildSiteIntelSection, _buildSocialIntelExecSection } = require('./site-intelligence');
...
const {
  ...
  VALID_TASK_STATUSES, RESEARCH_MAX_AGE_DAYS,
...
// (Proposal validation and envelope normalization now in normalization.js)
...
// (_resolveWorkspaceFiles now in workspace-context.js)
// (_fetchSiteIntel, _buildSiteIntelSection, _buildSocialIntelExecSection now in site-intelligence.js)
