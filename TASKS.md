...
## Status
Blindspot is a standalone arena combat card game at /blindspot/. 66 iterations shipped. Core loop works: landing → stranger fight → quick build → campaign (10 bosses with images) → forge → PvP. Needs polish to feel like a shippable game.
...
1. Sound effects for loot drops, boss defeats, ascension, forge completion
