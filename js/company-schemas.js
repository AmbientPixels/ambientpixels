...
var CompanySchemas = (function () {
  ...
  var TASK_TYPES = {
    ...
    social_facebook:  { label: 'Facebook Post',     pipeline: 'social',  requiresDoc: false, description: 'Post to the AmbientPixels Facebook Page (Graph API)' },
    social_instagram: { label: 'Instagram Post',    pipeline: 'social',  requiresDoc: false, description: 'Post to Instagram. ENGAGEMENT ONLY — captions cannot carry a clickable link, so no URLs. Image is rendered from the copy automatically.' },
