...
(function () {
  ...
  // ============================================================
  // DEBUG / CHEAT CONSOLE — browser console: BS.help()
  // ============================================================
  ...
  var BS_CHEATS = {
    ...
    // --- Charms ---
    charmList: function () {
      if (!_config || !_config.crates) { console.log('[BS] Game config not loaded yet'); return; }
      var items = _config.crates.dropPools.battle_charms.items;
    ...
    godMode: function () {
      ...
      if (_config && _config.crates && _config.crates.dropPools.battle_charms) {
        _progress.charms = [];
        _config.crates.dropPools.battle_charms.items.forEach(function (c) {
          for (var i = 0; i < 3; i++) _progress.charms.push(c.id);
        });
      }
      // Add all cosmetics
      if (_config && _config.crates) {
        var pools = _config.crates.dropPools;
