...
(function () {
  ...
  function renderLobby() {
    ...
    if (statsEl) {
      ...
      let streakHtml = '';
      if (streak >= 5) streakHtml = `<span class="bs-hud-streak--hot"><i class="fas fa-bolt-lightning"></i> ${streak}</span>`;
      else if (streak >= 3) streakHtml = `<span class="bs-hud-streak--warm"><i class="fas fa-bolt-lightning"></i> ${streak}</span>`;
      else if (streak > 0) streakHtml = `<span><i class="fas fa-bolt-lightning"></i> ${streak}</span>`;
