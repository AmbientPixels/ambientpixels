...
window.BsConst = (function () {
  ...
  return {
    ...
    MOVE_BEATS: MOVE_BEATS, BATTLE_HINTS: BATTLE_HINTS, STAMINA_COSTS: STAMINA_COSTS, STAMINA_EXHAUSTION_THRESHOLD: STAMINA_EXHAUSTION_THRESHOLD, COOLDOWN_ROUNDS: COOLDOWN_ROUNDS,
